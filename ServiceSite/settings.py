# Django settings for django_multiuploader project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_ROOT, 'database/CVTO_Database.sqlite3'),                     
...
SECRET_KEY = '+ujmb3tahhc#c8zld6v#%q85c)sv=x8ov(-xl%pte!&@o!kb40'
